...
import type { DrawStroke, NormPoint } from '../services/drawing.service';
...
export function DrawingCanvas({ strokes, color, width, onCommit }: DrawingCanvasProps) {
  ...
  const pan = useMemo(
    ...
    // begin/extend/finish are stable closures over refs + current color/width.
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [color, width, size.w, size.h],
  );
